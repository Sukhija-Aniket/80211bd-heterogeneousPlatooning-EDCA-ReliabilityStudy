...
print_usage() {
  ...
  echo -e "\t--position_model={platoon, uniform, default=platoon}    Specify position model used during simulation"
  ...
  echo -e "\nExample:"
  echo -e "\t$(basename "$0") test.cc --general_type=constant --critical_type=poisson --general_rate=5"
}
